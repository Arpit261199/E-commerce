...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='price_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='products.pricevariant'),
        ),
        migrations.AddField(
            model_name='product',
            name='quality_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='products.qualityvariant'),
        ),
        migrations.AddField(
            model_name='product',
            name='quantity_type',
